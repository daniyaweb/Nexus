...
import { Users, PieChart, Filter, Search, PlusCircle, Calendar, DollarSign } from 'lucide-react';
...
import { wallets } from '../../data/payments';
          ...
          <CardBody>
            <div className="flex items-center">
              ...
              <div>
                ...
                <h3 className="text-xl font-semibold text-accent-900">${userWallet?.balance.toLocaleString() || 0}</h3>
              </div>
            </div>
          </CardBody>
        </Card>
