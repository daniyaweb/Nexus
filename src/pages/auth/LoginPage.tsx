      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            {otpError && (
              <div className="mb-4 bg-error-50 border border-error-500 text-error-700 px-4 py-3 rounded-md text-sm">
                {otpError}
              </div>
            )}
            ...
            <div className="flex gap-1 justify-center mb-6">
              {otp.map((digit, index) => (
                <input
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 text-center text-lg font-bold border-2 border-gray-300 rounded-lg focus:outline-none focus:border-primary-500"
                />
              ))}
            </div>

            <Button fullWidth onClick={handleOTPVerify}>Verify & Sign In</Button>
